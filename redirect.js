(function() {
            ...
            Lampa.SettingsApi.addParam({
                ...
                onChange: function (value) {
                    if (value === '') {
                        ...
                        // Щоб не дублювати ініціалізацію, просто оновлюємо UI
                        $('#REDIRECT').remove();
                        ...
                        $('#REDIRECT').on('hover:enter hover:click hover:touch', function() {
                            var targetServer = Lampa.Storage.get('location_server');
                            if (targetServer) window.location.href = targetServer;
                        });
                    }
                }         
            });
    ...
    // Безпечний запуск через перевірку готовності ядра
    ...
    // Захист на випадок, якщо плагін вантажиться дуже довго
    setTimeout(function() {
        clearInterval(checkLoadTimer);
    }, 15000);
